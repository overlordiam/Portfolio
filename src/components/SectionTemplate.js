...
const SectionTemplate = ({ title, subtitle, projects, internships }) => {
  return (
    <div className="container mx-auto px-4 py-16">
      <h2 className="text-6xl font-bold mb-8 text-center">{title}</h2>
      <h3 className="text-2xl font-bold mb-8 text-center">{subtitle}</h3>

      {/* Internships Section */}
      {internships && internships.length > 0 && (
        <>
          <h3 className="text-5xl font-bold mt-12 mb-12 text-center">Internships</h3>
      ...
      {/* Projects Section */}
      <h3 className="text-5xl font-bold mt-12 mb-12 text-center">Projects</h3>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
